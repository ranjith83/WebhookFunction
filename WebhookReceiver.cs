...
namespace Flipdish.Recruiting.WebhookReceiver
{
    ...
    {
        private readonly IWebhookMessage _webhookService;
        public WebhookReceiver(IWebhookMessage service)
        {
          //  this._client = httpClientFactory.CreateClient();
            this._webhookService = service;
        }
        ...
        {
            var emailOrder = await _webhookService.PostMessageAsync(req.Body, context.FunctionAppDirectory, req.Query, log);
        ...
        public async Task<IActionResult> GetMessage(
           ...
           ExecutionContext context)
        {
            var emailOrder = await _webhookService.GetMessageAsync(context.FunctionAppDirectory, req.Query, log);
